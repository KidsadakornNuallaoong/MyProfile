  ...
  return (
    <>
        ...
        <div className="text-tertiary flex flex-col md:flex-row space-y-[5rem] max-screen items-center justify-evenly md:space-y-0 md:space-x-[5rem] mt-20 px-5 md:px-12 lg:px-20">
          ...
          <div className="card min-w-[300px] h-[450px] md:w-[100px] md:h-[400px] lg:w-[400px] lg:h-[600px] bg-[#10111E] border-[#72758F] border-2 rounded-[25px] flex justify-center items-start">
